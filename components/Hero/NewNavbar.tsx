      ...
      <Menu setActive={setActive}>
        ...
        {/* <MenuItem setActive={setActive} active={active} item="Videos">
          <div className="flex flex-col space-y-3 text-sm min-w-[140px]">
            <HoveredLink href="/#videos">Vídeos de YouTube</HoveredLink>
            <HoveredLink href="https://www.youtube.com/@L4zarusDev">Canal de YouTube</HoveredLink>
          </div>
        </MenuItem>*/}
        <MenuItem setActive={setActive} active={active} item="Projects">
          <div className="flex flex-col space-y-3 text-sm min-w-[120px]">
            <HoveredLink href="/#services">Servicios</HoveredLink>
            <HoveredLink href="https://github.com/L4zarusDev">GitHub</HoveredLink>
          </div>
        </MenuItem>

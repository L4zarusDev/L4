  ...
  return (
    <>
      ...
      >
        ...
        >
          Descargue mi currículum para conocer más sobre mi experiencia, habilidades y cómo puedo ayudarle a darle vida a su próximo proyecto.
        </motion.p>
        <motion.a
          href="/L4.docx"
          download
          className="mt-8 inline-block rounded-full bg-black px-8 py-3 text-sm uppercase text-white transition-all hover:bg-black"
